...
public class rocker : MonoBehaviour,IBeginDragHandler,IEndDragHandler,IDragHandler
{
	...
	public void OnDrag (PointerEventData data)
	{
		...
		if (distance > radius) {			
			Joystick.position = a;
//			Vector3 trans = (Joystick.position - a) * radius / distance;
//			Joystick.position = trans;
		} 
